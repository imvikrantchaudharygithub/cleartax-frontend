...
interface BankingFinanceSectionProps {
  serverData?: { category: any; subcategories: any[] } | null;
}

export default function BankingFinanceSection({ serverData }: BankingFinanceSectionProps) {
  ...
  const fetchData = async () => {
    try {
      ...
      const fetchPromise = (async () => {
        const result = await serviceService.getCategoryWithSubcategories('banking-finance');
